...
namespace InterviewSelectionProcess.Controllers
{
    public class CandidateStatusController : Controller
    {
        ...
        public ActionResult Index(string SearchPost,string SearchTech,int? SearchExperience)
        {
            ...
            {
                candidateStatus = candidateStatus.Where(s => s.Candidate.Post.PostName.Contains(SearchPost) && s.Candidate.Technology.Technology1.Contains(SearchTech) && s.Candidate.Experience==SearchExperience);
            }
